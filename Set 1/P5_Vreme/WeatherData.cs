...
namespace P5_Vreme
{
    public enum Season { Iarna, Primavara, Vara, Toamna }

    public static class WeatherData
    {
        public static readonly ImmutableDictionary<string, Dictionary<Season, double>> Data = new Dictionary<string, Dictionary<Season, double>>
        {
