    ...
    public class SeqFinder
    {
        ...
        private void Main()
        {
            ...
            while (_running)
            {
                ...
                var seqGenerator = GetSeqGenerator(seqType);
        ...
        private ISequenceGenerator GetSeqGenerator(SeqType type)
        {
            switch (type)
            {
                case SeqType.Fibonacci: return new FibonacciSequence();
                case SeqType.Factorial: return new FactorialSequence();
                case SeqType.Geometric: return new GeometricSequence();
                case SeqType.PerfectSq: return new PerfectSquareSequence();
                case SeqType.PrimeNums: return new PrimeNumbersSequence();
                default: return new TriangularSequence();
            }
        }
